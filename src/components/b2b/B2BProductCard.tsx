  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden border border-border bg-card transition-shadow hover:shadow-[var(--shadow-soft)]">
      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        ...
        <dl className="mt-1 grid grid-cols-2 gap-x-4 gap-y-1.5 text-xs text-muted-foreground">
          <div>
        ...
        <div className="mt-auto flex flex-wrap items-center gap-3 pt-3">
          <Link
            ...
            className="inline-flex items-center gap-2 bg-navy px-4 py-2.5 text-xs uppercase tracking-[0.18em] text-beige transition-colors hover:bg-teal"
          >
            Enquire
          </Link>
          <SmartLink
            to={`/b2b/product/${product.id}`}
            className="inline-flex items-center gap-1.5 text-xs uppercase tracking-[0.18em] text-teal link-gold"
          >
