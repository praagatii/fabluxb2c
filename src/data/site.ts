...
export const heroSlides: HeroSlide[] = [
  {
    ...
    primaryCta: { label: "Explore refrigerators", to: "/shop/refrigerators" },
  ...
  },
  {
    ...
    primaryCta: { label: "Explore washers", to: "/shop/washing-machines" },
